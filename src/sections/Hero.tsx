...
const Hero: React.FC<HeroProps> = ({ onBuildNowClick }) => {
    return (
        ...
        >
            ...
            >
                <button onClick={onBuildNowClick} className="px-6 py-3 rounded-lg font-semibold text-base transition-all duration-200 bg-[var(--accent)] text-[var(--accent-text)] hover:brightness-110 hover:scale-105 active:scale-100">
                    Build Now
                </button>
