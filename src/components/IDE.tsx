...
const IDE = () => {
    ...
    const updatePreview = (generatedFiles: AppFile[]) => {
        ...
        if (!htmlFile) {
            ...
            // Attempt to create a basic HTML file if missing
...
<html>
  ...
  <body>
    <p>Error: Main HTML file was not generated by the AI.</p>
  </body>
</html>`;
    ...
    const handlePromptSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Call the secure backend endpoint instead of Gemini API directly
