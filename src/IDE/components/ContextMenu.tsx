...
const ContextMenu: React.FC<ContextMenuProps> = ({ x, y, items, closeMenu }) => {
  ...
  return (
    <div
      style={style}
      className="fixed bg-[var(--background-secondary)]/90 backdrop-blur-lg border border-[var(--border-color)] rounded-md shadow-2xl py-1 z-[100] text-white animate-fade-in-up w-52"
    >
      <ul>
