...
const TitleBar: React.FC<TitleBarProps> = ({ panelVisibility, onTogglePanel, onLogout }) => {
  return (
    <div className="bg-[var(--ui-panel-bg-heavy)] text-white/90 px-4 py-2 flex items-center justify-between border border-[var(--ui-border)] flex-shrink-0 rounded-t-[var(--ui-border-radius)] shadow-xl">
